    ...
    <el-row :gutter="20" class="homeTopUserDashboard">
      ...
      <el-col :span="8">
        ...
        <el-card shadow="hover" class="homeBottomUserInfo">
          ...
          <el-progress :percentage="78" color="#42b983"></el-progress>React
          <el-progress :percentage="60" color="#f1e05a"></el-progress>DIV、CSS、HTML
          <el-progress :percentage="95"></el-progress>微信小程序
...
.homeUserLineChart .el-card__body {
  height: auto;
  overflow-y: auto;
  padding: 0px !important;
}
